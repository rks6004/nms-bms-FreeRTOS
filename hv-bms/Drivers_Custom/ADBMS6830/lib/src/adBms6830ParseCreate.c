 ...
 *
 * @param [in]  *ic                      cell_asic_6830 ic structure pointer
 *
 ...
 *******************************************************************************
*/
void SetConfigB_DischargeTimeOutValue(uint8_t tIC, cell_asic_6830 *ic, DTRNG timer_rang, DCTO timeout_value)
{
 ...
 *******************************************************************************
*/
void SetPwmDutyCycle(uint8_t tIC, cell_asic_6830 *ic, PWM_DUTY duty_cycle)
{
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParseConfiga(uint8_t tIC, cell_asic_6830 *ic, uint8_t *data)
{
  uint8_t address = 0;
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParseConfigb(uint8_t tIC, cell_asic_6830 *ic, uint8_t *data)
{
  uint8_t address = 0;
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParseConfig(uint8_t tIC, cell_asic_6830 *ic, GRP grp, uint8_t *data)
{
  switch (grp)
  {
  case A:
...
void adBms6830ParseSCell(uint8_t tIC, cell_asic_6830 *ic, GRP grp, uint8_t *scv_data)
{
  uint8_t *data, data_size, address = 0;
 ...
 *******************************************************************************
*/
void adBms6830ParseFCell(uint8_t tIC, cell_asic_6830 *ic, GRP grp, uint8_t *fcv_data)
{
  uint8_t *data, data_size, address = 0;
 ...
 *******************************************************************************
*/
void adBms6830ParseAux(uint8_t tIC, cell_asic_6830 *ic, GRP grp, uint8_t *aux_data)
{
  uint8_t *data, data_size, address = 0;
 ...
 *******************************************************************************
*/
void adBms6830ParseRAux(uint8_t tIC, cell_asic_6830 *ic, GRP grp, uint8_t *raux_data)
{
  uint8_t *data, data_size, address = 0;
 ...
 *******************************************************************************
*/
void adBms6830ParseStatusA(uint8_t tIC, cell_asic_6830 *ic, uint8_t *data)
{
  uint8_t address = 0;
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParseStatusB(uint8_t tIC, cell_asic_6830 *ic, uint8_t *data)
{
  uint8_t address = 0;
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParseStatusC(uint8_t tIC, cell_asic_6830 *ic, uint8_t *data)
{
  uint8_t address = 0;
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParseStatusD(uint8_t tIC, cell_asic_6830 *ic, uint8_t *data)
{
  uint8_t address = 0;
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParseStatusE(uint8_t tIC, cell_asic_6830 *ic, uint8_t *data)
{
  uint8_t address = 0;
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParseStatus(uint8_t tIC, cell_asic_6830 *ic, GRP grp, uint8_t *data)
{
 ...
 *******************************************************************************
*/
void adBms6830ParseComm(uint8_t tIC, cell_asic_6830 *ic, uint8_t *data)
{
  uint8_t address = 0;
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParseSID(uint8_t tIC, cell_asic_6830 *ic, uint8_t *data)
{
  uint8_t address = 0;
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParsePwma(uint8_t tIC, cell_asic_6830 *ic, uint8_t *data)
{
  uint8_t address = 0;
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParsePwmb(uint8_t tIC, cell_asic_6830 *ic, uint8_t *data)
{
  uint8_t address = 0;
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830ParsePwm(uint8_t tIC, cell_asic_6830 *ic, GRP grp, uint8_t *data)
{
  switch (grp)
  {
    case A:
 ...
 *******************************************************************************
*/
void adBms6830CreateConfiga(uint8_t tIC, cell_asic_6830 *ic)
{
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830CreateConfigb(uint8_t tIC, cell_asic_6830 *ic)
{
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830CreateClrflagData(uint8_t tIC, cell_asic_6830 *ic)
{
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830CreateComm(uint8_t tIC, cell_asic_6830 *ic)
{
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830CreatePwma(uint8_t tIC, cell_asic_6830 *ic)
{
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
 ...
 *******************************************************************************
*/
void adBms6830CreatePwmb(uint8_t tIC, cell_asic_6830 *ic)
{
  for(uint8_t curr_ic = 0; curr_ic < tIC; curr_ic++)
  {
