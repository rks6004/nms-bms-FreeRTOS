...
extern uint8_t CLRC[2];//Ask about CLRC//Sayani
...
//Command + pec
extern uint8_t RSTATD[4];  //Command +Pec
//extern uint8_t RSTATC[4]; // Tiger CC is in Status C
extern uint8_t RFLAG[4]; // Tiger CC is in Flag//Check PEC code//Sayani//Put breakpoint at Pec15_Calc for RDFLAG to check
extern uint8_t sRDI[4];
extern uint8_t sCLRAB[4];
...
extern uint8_t TM_48[2];       // LION: RDSVE
